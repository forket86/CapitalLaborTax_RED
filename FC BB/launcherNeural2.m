...
% 1. limited state contingent labor and capital tax with symmetric cost=39
% 2. fully state contingent labor tax and limited state contingent capital tax with cost=39
% 3. fully state contingent capital tax and limited state contingent labor tax with cost=39
MODEL=1;
warning off
if MODEL==1
    load(['./INIT/chi0_39_psi0_39'])
elseif MODEL==2
    load(['./INIT/chi0_0dot01_psi0_39'])
elseif MODEL==3
    load(['./INIT/chi0_39_psi0_0dot01'])
end
warning on
...
for iter=1:100000
    ...
    if errMainLoop(iter)<1e-3
        if MODEL==1
            save(['./INIT/chi0_39_psi0_39_temp'])
        elseif MODEL==2
            save(['./INIT/chi0_0dot01_psi0_39_temp'])
        elseif MODEL==3
            save(['./INIT/chi0_39_psi0_0dot01_temp'])
        end
        break;
    end
